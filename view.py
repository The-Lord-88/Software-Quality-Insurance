 ...
 * @Last Modified time: 2019-03-20 15:19:16 
 */"""
...
class View:
    # Here we initiate our calculator by creating each button and associating a click handler to it
    # This method is pretty long, but it is tolerated as it mostly initializes variables
    # Therefore, it is very easy to debug and understand
    def __init__(self, master):
        ...
        self.display_label = Label(master, anchor = E,
    ...
    # Here we just set the click handler that will call our controller when a button is pressed
